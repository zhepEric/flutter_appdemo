...
class _CameraStartStopState extends State<CameraDemo> {
  bool isPlaying = true;
  ...
  @override
  void didUpdateWidget(CameraDemo oldWidget) {
        ...
        new Expanded(
          child: new Center(
            child: new AspectRatio(
              ...
              child: new CameraDemo(controller),
            ),
          ),
        ),
      );
